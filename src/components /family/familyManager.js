export const getFamilies = () => {
    return fetch("https://vittles-c.herokuapp.com/families", {
        headers:{
...
export const getFamily = (familyId) => {
    return fetch(`https://vittles-c.herokuapp.com/families/${familyId}`, {
        headers:{
            "Authorization": `Token ${localStorage.getItem("v_token")}`
        }
    })
...
export const getCurrentUser = () => {
    return fetch(`https://vittles-c.herokuapp.com/families/getCurrentUser`, {
        headers:{
            "Authorization": `Token ${localStorage.getItem("v_token")}`
        }
    })
